...
import com.codestroke.codestrokealert.Utility;
import com.codestroke.codestrokealert.activity.clinicians.CliniciansPatientDetails;
import com.codestroke.codestrokealert.activity.clinicians.RecyclerViewItemClickListener;
import com.codestroke.codestrokealert.adapter.PatientRecyclerViewAdapter;
...
public class IncomingCasesFragment extends Fragment implements RecyclerViewItemClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        Type type = new TypeToken<List<Cases>>() {
        }.getType();
